            ...
            <div className='flex items-center gap-12 px-1 py-2 '>
                ...
                <div className="Navlist ">
                    <ul className='flex gap-8 justify-evenly'>
                        <li className="border-b-3 border-[#fff0] hover:border-[#ffffff] rounded-xs p-1 ">Browse</li>
                        <li className="hover:border-b-3 bo border-[#ffffff] rounded-xs p-1 ">My List</li>
                        <li className="hover:border-b-3 bo border-[#ffffff] rounded-xs p-1 ">Add Movie</li>
                    </ul>
                </div>
            </div>
        </div>
